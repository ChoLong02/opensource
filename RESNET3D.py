...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        dense4 = Dense(units=256,
                       kernel_initializer="he_normal",
                       activation="relu",
                       kernel_regularizer=l2(reg_factor))(flatten1)

        dense3 = Dense(units=128,
                      kernel_initializer="he_normal",
                      activation="relu",
                      kernel_regularizer=l2(reg_factor))(dense4)
        ...
        if num_outputs > 1:
            ...
            dense = Dense(units=32,
                          kernel_initializer="he_normal",
                          activation="relu",
                          kernel_regularizer=l2(reg_factor))(dense2)
    ...
    def build_resnet_18(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 18."""
        return Resnet3DBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 2, 2], reg_factor=reg_factor)
